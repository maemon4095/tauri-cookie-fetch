...
use reqwest::header;
use std::sync::Mutex;
use tauri::{http::status::StatusCode, AppHandle, Manager, State};
...
pub async fn connect(state: State<'_, IpcState>) -> Result<usize, String> {
...
pub fn uri_scheme_protocol<R: tauri::Runtime>(
    app: &AppHandle<R>,
